...
def main():
    ...
    ap.add_argument("--out_news", default="data/NAVER/article/news_2025_증시금리.csv")
    ap.add_argument("--out_comments", default="data/NAVER/comments/comments_2025_증시금리.csv")
